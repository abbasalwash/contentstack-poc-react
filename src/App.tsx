...
import ImpactStory from "./pages/impact-story";
import {getImpactStoriesPageRes, getImpactStoryRes} from "./helper";
import ImpactStories from "./pages/impact_stories";
    ...
    <div className="App">
      <Routes>
        <Route path="/" element={<Layout entry={getEntry} />}>
          ...
          />
          <Route path="/impact_stories" element={<ImpactStories entry={getImpactStoriesPageRes} />} />
          <Route path="/impact_stories/:storyId" element={<ImpactStory entry={getImpactStoryRes} />} />
